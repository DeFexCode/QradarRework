...
public class VPNCaptureActivity extends FragmentActivity {
    ...
    ActivityResultLauncher<Intent> overlayPermissionResultLauncher = registerForActivityResult(
            ...
            result -> {
                if (!Settings.canDrawOverlays(this)) {
                    ...
                    // Handle the case where the user declined the permission
                }
            }
    );
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!value.equals("true") || daysAmount <= 0) {
            startLoginActivity(); // Launch the login activity if login fails or days are depleted
        }
            ...
            while (execution) {
                ...
                HttpTask.Callback callback = new HttpTask.Callback() {
                    ...
                    public void onFailure(String errorMessage) {
                        runOnUiThread(() -> {
                            startLoginActivity(); // Launch the login activity on failure
                        });
                        execution = false;
                    }
                };
    ...
    public void initMainFragment() {
        // Initialize your main fragment here
    }
